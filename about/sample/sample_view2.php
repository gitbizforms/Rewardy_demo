...
include "../editors/ckeditor/plugins/mong9-editor/includes/functions/content-filter.php";
...
// Extract and output only user-defined functions
$userDefinedFunctions = array_diff($definedFunctions['user'], $definedFunctions['internal']);
...
// $html = Mong9_Html_Convert($ch_contents);
// echo $html;
?>
