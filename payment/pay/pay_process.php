...
$price = ($people * $people_price) * 0.05;
...
?>
    ...
    ?>
     <form name="" id="SendPayForm_id" method="post" class="mt-5">
                ...
                <input type="hidden" name="returnUrl" value="http://localhost:8090/payment/pay/pay_return.php">
                <input type="hidden" name="closeUrl" value="http://localhost:8090/payment/pay/close.php">
