...
include_once($home_pay . "PHPMailer/libphp-phpmailer/PHPMailerAutoload.php");
    ...
    $sql = $sql ." values('1','bapzelo97@naver.com','(주)비즈폼','3', '리워디' , '0')";
    ...
    if($insert_idx){
        ...
        $title = "리워디 인증 이메일입니다.";
        $secret = "send_email=".$send_email."&to_email=bapzelo97@naver.com&sendno=".$insert_idx;
        ...
        $result = mailer($send_name, $smtp_email, 'bapzelo97@naver.com', $title, $contents);
