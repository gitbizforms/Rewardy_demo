<?
	...
	$sql = "select a.idx, a.email, a.partno, a.part, a.company, a.companyno, a.name, a.profile_type, a.profile_img_idx, b.file_path, b.file_name from work_member as a, work_member_profile_img as b where a.email = b.email and a.state = '0' and b.state = '0' and a.companyno = '".$companyno."' order by a.partno desc";
	...
	if($chall_idx){
		...
		if($ch_info['idx']){
			//value값이 들어가여 되는데 idx 말고 email이 들어강 ㅣㅆ음 이거 수정하기
											...
											<div class="rew_cha_write_in">
												...
												<div class="rew_cha_write_type">
													<div class="title_area">
														<input type="hidden" id="user_id_secret" value="<?=$user_id?>">
