<?php
	...
	$sql = "select idx from work_member where state in('0','1') and companyno='".$companyno."' and highlevel!='1' order by idx asc";
					...
					<div class="rew_conts_in">
						...
						<div class="rew_member_tab">
							<div class="rew_member_tab_in">
								<ul>
									<li class="member_list on"><a href="#"><span>멤버관리</span></a></li>
											...
											<div class="list_paging" id="list_paging">
														...
														?>
															<li id="li_<?=$mem_idx?>">
																...
																<div class="member_list_conts_function">
																	...
																	<!--<button class="btn_list_reset" id="btn_list_reset_<?=$mem_idx?>" value="<?=$member_info['email'][$i]?>" ><span>초기화</span></button>-->
												...
												<div class="rew_ard_paging" id="rew_ard_paging">
													<div class="rew_ard_paging_in">
														<input type="hidden" id="tclass" value="up">
