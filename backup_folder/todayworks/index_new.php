...
$sql = "select idx, state, service, title, contents, email, workdate, date_format( regdate , '%m/%d/%y %l:%i:%s %p') as reg, work_idx
		from work_alarm
		where 1=1
		and state = '0'
		and email = '".$member_row_info['email']."'
							...
							<div class="tdw_tab_left">
								<div class="tdw_tab_sort sort_01">
									<div class="tdw_tab_sort_in">
										<button class="btn_sort_on select_dd day" value="일일"><span>일일</span></button>
								...
								<div class="tdw_tab_sort sort_02">
									<div class="tdw_tab_sort_in">
										<button class="btn_sort_on work" value="업무 전체보기"><span>업무 전체보기</span></button>
								...
								<div class="rew_todaywork_in">
									<div class="tdw_penalty_banner" style = "display:none;">
										<div class="tdw_pb_in">
											...
											<strong class="penalty_comp" style="display:none;"><span>미션 완료</span></strong><!-- 미션 완료 -->
										</div>
									</div>
																				...
																				<div class="tdw_list_1depth">
																					<ul>
																						...
																						<?//공유하기?>
																							...
																							<?}else{?>
																								...
																								<?if(($work_flag=='2' && $work_idx==null) || ($share_flag=='1' && $work_idx==null)){?>
																									<button class="tdw_list_share tdw_list_s" id="tdw_list_share" value="<?=$idx?>" title="공유"><span>공유</span></button>
																								<?}?>
																							<?}?>
																						</li>
																						<li>
																						...
																						<li>
																							...
																							<button class="tdw_list_memo tdw_list_m" id="tdw_list_memo" value="<?=$idx?>" title="메모"><span>메모</span></button>
																							<?}?>
																						</li>
																						<li>
			...
			<div class="ff_box">
				<div class="ff_box_in">
					...
					<div class="ff_area">
						<ul>
							<li>
								<button class="btn_ff_01">
									<strong></strong>
									<span>최고야</span>
								</button>
							</li>
							<li>
								<button class="btn_ff_02">
									<strong></strong>
									<span>뿌듯해</span>
								</button>
							</li>
							<li>
								<button class="btn_ff_03">
									<strong></strong>
									<span>기분좋아</span>
								</button>
							</li>
							...
							<li>
								<button class="btn_ff_04">
									<strong></strong>
									<span>감사해</span>
								</button>
							</li>
							<li>
								<button class="btn_ff_05">
									<strong></strong>
									<span>재밌어</span>
								</button>
							</li>
							<li>
								<button class="btn_ff_06">
									<strong></strong>
									<span>수고했어</span>
								</button>
							</li>
							...
							<li>
								<button class="btn_ff_07">
									<strong></strong>
									<span>무난해</span>
								</button>
							</li>
							<li>
								<button class="btn_ff_08">
									<strong></strong>
									<span>지쳤어</span>
								</button>
							</li>
							<li>
								<button class="btn_ff_09">
									<strong></strong>
									<span>속상해</span>
								</button>
							</li>
			...
			<div class="fl_box">
				<div class="fl_box_in">
					...
					<div class="fl_area">
						...
						<div class="fl_input">
							<input type="text" class="input_fl" placeholder="한줄소감을 남겨주세요!" />
						</div>
					</div>
					<div class="fl_bottom">
						<button>등록하기</button>
