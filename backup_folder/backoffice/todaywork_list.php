								...
								<tbody>
									<?
										...
										<tr>
											...
											<td class="work_state_<?=$query['idx'][$i]?>"><?=$query['state'][$i]?></td> 
											<td><?=$query['company'][$i]?></td>
											<td class="work_content">
												<p><?=$query['contents'][$i]?></p>
												<input class="form-control form-control-sm" id="content_edit" type="text" value="<?=$query['contents'][$i]?>" style="display:none;font-size:11px;">
											</td>
											<td><?=$repeat_flag?></td>
											<td><?=$query['workdate'][$i]?></td>
											<td class="btn-group btn-group-sm d-flex" id="back_btn" value="<?=$query['idx'][$i]?>" role="group" style="position:relative;z-index:1;">
