<?
    ...
    //오늘 보고 수치
    $sql = "select count(idx) as cnt from work_todaywork_like where state = '0' and service = 'lives' ";
    $query = selectQuery($sql);
    ...
    //오늘 공유 수치
    $sql = "select count(idx) as cnt from work_todaywork_like where state = '0' and service = 'project' ";
    $query = selectQuery($sql);
                                ...
                                <table class="table mx-2 table-bordered rounded mt-3 " id="backoff_table" style="width:70%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><div class="back_sortkind" value="lives">라이브<input type="hidden" id="pie_title_1" value="라이브"></div></th>
                                            <th><div class="back_sortkind" value="memo">메모<input type="hidden" id="pie_title_2" value="메모"></div></th>
                                            <th><div class="back_sortkind" value="project">파티<input type="hidden" id="pie_title_3" value="파티"></div></th>
