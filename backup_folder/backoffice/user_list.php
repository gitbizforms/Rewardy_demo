                                ...
                                <table class="table table-bordered rounded-1" id="backoff_table" class="rounded-1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><div class="back_sortkind" value="comcoin">공용코인<button class="list_arrow" value="btn_sort_down"></button></div></th>
                                            <th><div class="back_sortkind" value="coin">코인<button class="list_arrow" value="btn_sort_down"></button></div></th>
                                            <th><div class="back_sortkind" value="login_count">누적 로그인<button class="list_arrow" value="btn_sort_down"></button></div></th>
                                            <th><div class="back_sortkind" value="login_date">마지막 로그인시간<button class="list_arrow" value="btn_sort_down"></button></div></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?
