                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <table class="table table-bordered rounded-1 mt-3" id="backoff_table" class="rounded-1">
                                    <thead>
                                        <tr>
                                            <th class="backoff_date"><div class="back_sortkind" value="regdate">등록시간 <button class="list_arrow" value="btn_sort_down"></button></div></th>
                                            <th class="backoff_coinname"><div class="back_sortkind" value="reward_user">지급자 <button class="list_arrow" value="btn_sort_down"></button></div></th>
                                            <th class="backoff_coinname"><div class="back_sortkind" value="email">지급받는자 <button class="list_arrow" value="btn_sort_down"></button></div></th>
                                            <th><div class="back_sortkind" value="coin">코인 <button class="list_arrow" value="btn_sort_down"></button></div></th>
                                            <th><div class="back_sortkind" value="code">보상유형 <button class="list_arrow" value="btn_sort_down"></button></div></th>
											<th><div class="backoff_memo" value="code">메모</div></th>
                                    ...
                                    <tbody>
                                        <?
											...
											<tr>
												...
												<td><?=$coin_kind?></td>
												<td class="backoff_memo"><p><?=$query['memo'][$i]?></p></td>
