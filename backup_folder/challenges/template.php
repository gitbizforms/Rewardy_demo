...
<?
	...
	$sql = "select count(1) as cnt from work_challenges where state = '0' and coaching_chk = '0' and temp_flag = '0' and template = '1' and view_flag = '0'";	
	...
	$sql = $sql .= " from work_challenges as a where a.state = '0' and a.coaching_chk = '0' and a.temp_flag = '0' and a.template = '1' and a.view_flag = '0'"; 
	$sql = $sql .= " order by a.idx desc limit 0,12";
					...
					<div class="rew_conts_in" id="rew_conts_in">
						...
						<div class="rew_cha_list_func">
							<div class="rew_cha_list_func_in">
								...
								<div class="rew_cha_sort cha_sort_02" style="right:240px" id="template_sort">
								...
								<div class="rew_cha_search cha_search_02" style="right:10px" id="rew_cha_search">
