<?
	...
	//오늘 마음전하기
	$sql = "select top 1 email, name, count(1) as cnt from work_todaywork_like where state='0' and service='lives' and like_flag='0' and workdate='".TODATE."' group by email, name";
	...
	*/
	...
	$sql = $sql .=" where a.state='0'";
	$sql = $sql .=" AND ( (b.state='1' and a.attend=(select count(1) from work_challenges_result where state='1' and challenges_idx=a.idx and email='".$user_id."'))) and a.coaching_chk='0' and a.view_flag='0' and a.temp_flag='0' and a.template='0' and a.companyno ='".$companyno."' group by a.idx) as c";
														...
														<div class="ldr_li_in">
															...
															<div class="ldr_numbers">
																...
																<?//if($user_id=='sadary0@nate.com'){
																	...
																	//echo $like_list[$member_list_email]." && ". $like_list[$member_list_email] ." == ". $reward_cp_info['21']['like']['now']['cnt'];
																	//좋아요 10개 회득!
																	if($like_list[$member_list_email] && $like_list[$member_list_email] == $reward_cp_info['21']['like']['now']['cnt']){?>
																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																				<strong><?=$reward_cp_info['21']['like']['now']['memo']?></strong>
																			</div>
																		</div>
																	<?
																	}
																	...
																	//좋아요 20개 회득!
																	if($like_list[$member_list_email] && $like_list[$member_list_email] == $reward_cp_info['20']['like']['now']['cnt']){?>
																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																				<strong><?=$reward_cp_info['20']['like']['now']['memo']?></strong>
																			</div>
																		</div>
																	<?
																	}
																	...
																	//좋아요 30개 회득!
																	if($like_list[$member_list_email] && $like_list[$member_list_email] == $reward_cp_info['19']['like']['now']['cnt']){?>
																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																				<strong><?=$reward_cp_info['19']['like']['now']['memo']?></strong>
																			</div>
																		</div>
																	<?
																	}
																	...
																	//좋아요 40개 회득!
																	if($like_list[$member_list_email] && $like_list[$member_list_email] == $reward_cp_info['18']['like']['now']['cnt']){?>
																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																				<strong><?=$reward_cp_info['18']['like']['now']['memo']?></strong>
																			</div>
																		</div>
																	<?
																	}
																	...
																	if($like_day_info_list[$member_list_email]){?>
																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																				<strong><?=$reward_cp_info['16']['like']['pre']['memo']?></strong>
																			</div>
																		</div>
																	<?}
																	...
																	if($reward_day_info_list[$member_list_email]){?>
																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																				<strong><?=$reward_cp_info['15']['cp']['pre']['memo']?></strong>
																			</div>
																		</div>
																	<?}

																	//역량 100점획득!
																	if($reward_tot_info_list[$member_list_email] == $reward_cp_info['14']['cp']['now']['cnt'] ){?>
																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																				<strong><?=$reward_cp_info['14']['cp']['now']['memo']?></strong>
																			</div>
																		</div>
																	<?}
																	...
																	/*if($user_id == 'sadary0@nate.com' && $member_list_email=='sadary0@nate.com'){?>

																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in">
																				<strong>전날 좋아요 2등</strong>
																			</div>
																		</div>

																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in">
																				<strong>전날 좋아요 3등</strong>
																			</div>
																		</div>

																		<div class="ldr_jjim_pop">
																			<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in">
																				<strong>전날 좋아요 5등</strong>
																			</div>
																		</div>
																	...
																	//성과 A
																	$cp_type = reward_cp_type_info($reward_cp_cnt['type2'][$member_list_email], 2);
																	if($cp_type){
																		$cp_rate_info = cp_rate_info($cp_type['cp_type']);
																		if($cp_rate_info == 'A'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['12']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	//협업 A
																	$cp_type = reward_cp_type_info($reward_cp_cnt['type4'][$member_list_email], 4);
																	if($cp_type){
																		$cp_rate_info = cp_rate_info($cp_type['cp_type']);
																		if($cp_rate_info == 'A'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['11']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	//실행 A
																	$cp_type = reward_cp_type_info($reward_cp_cnt['type6'][$member_list_email], 6);
																	if($cp_type){
																		$cp_rate_info = cp_rate_info($cp_type['cp_type']);
																		if($cp_rate_info == 'A'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['10']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	//성실 A
																	$cp_type = reward_cp_type_info($reward_cp_cnt['type5'][$member_list_email], 5);
																	if($cp_type){
																		$cp_rate_info = cp_rate_info($cp_type['cp_type']);
																		if($cp_rate_info == 'A'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['9']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	//성장 A
																	$cp_type = reward_cp_type_info($reward_cp_cnt['type3'][$member_list_email], 3);
																	if($cp_type){
																		$cp_rate_info = cp_rate_info($cp_type['cp_type']);
																		if($cp_rate_info == 'A'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['8']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	//지식 A
																	$cp_type = reward_cp_type_info($reward_cp_cnt['type1'][$member_list_email], 1);
																	if($cp_type){
																		$cp_rate_info = cp_rate_info($cp_type['cp_type']);
																		...
																		if($cp_rate_info == 'A'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['7']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	if($cp_type){
																		...
																		if($cp_rate_info == 'S'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['6']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	if($cp_type){
																		...
																		if($cp_rate_info == 'S'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['5']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	if($cp_type){
																		...
																		if($cp_rate_info == 'S'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['4']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	if($cp_type){
																		...
																		if($cp_rate_info == 'S'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['3']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	if($cp_type){
																		...
																		if($cp_rate_info == 'S'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['2']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
																	...
																	if($cp_type){
																		...
																		if($cp_rate_info == 'S'){?>
																			<div class="ldr_jjim_pop">
																				<div class="ldr_jjim_pop_in" id="ldr_jjim_pop_in" title="보상하기">
																					<strong><?=$reward_cp_info['1']['cp']['now']['memo']?></strong>
																				</div>
																			</div>
																		<?}
																	}
		...
		<div class="jg_in">
			<div class="jg_box">
				<div class="jg_box_in">
						...
						<div class="jg_graph_area">
							<div class="jg_graph_area_in">
								<ul class="jg_graph_list" id="jg_graph_list">
									<li class="jg_g01">
										<span>12</span>
										<strong style="height: 43.2px;"></strong>
									</li>
									<li class="jg_g02">
										<span>5</span>
									...
									<li class="jg_g03">
										<span>4</span>
										<strong style="height: 14.4px;"></strong>
									</li>
									<li class="jg_g04">
										<span>5</span>
										<strong style="height: 18px;"></strong>
									...
									<li class="jg_g05">
										<span>7</span>
										<strong style="height: 25.2px;"></strong>
									</li>
									<li class="jg_g06">
										<span>5</span>
										<strong style="height: 18px;"></strong>
					...
					<div class="jg_bottom">
						<button id="jg_bottom"><span>상세보기</span></button>
					</div>
		...
		<div class="jt_in">
			<div class="jt_box">
				<div class="jt_box_in">
					...
					<div class="jt_top">
						<button><strong>상세보기</strong></button>
					</div>
					<div class="jt_area">
						<div class="jt_user_area">
							...
							<div class="jt_user_right">
								<div class="jt_user_right_in">
									...
									<button class="jt_user_btn_coin" id="jt_user_btn_coin"><span>코인으로 보상하기</span></button>
								</div>
							</div>
						</div>
						...
						<div class="rl_user_area">
							<div class="rl_user_left">
								<div class="rl_user_left_in">
									...
									<div class="rl_name">
										...
										<input type="hidden" id="rl_name_id">
									</div>
								</div>
							</div>
							...
							<div class="rl_user_right">
								<div class="rl_user_right_in">
									...
									<button class="rl_user_btn_coin" id="rl_user_btn_coin"><span>코인으로 보상하기</span></button>
								</div>
							</div>
						</div>
