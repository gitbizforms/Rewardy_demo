    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link collapsed" id="collapse_pay" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePay" aria-expanded="false" aria-controls="collapsePages">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-coins"></i></div>
                    결제
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="collapsePay" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                        <a class="nav-link <?=$url=="backuser_list"?'text-light':''?>" href="user_list.php">결제 리스트</a>
                        <a class="nav-link collapsed <?=$url=="backcomp_list"?'text-light':''?>" href="company_list.php" >카드 결제</a>
                    </nav>
                </div>
                ...
                <a class="nav-link collapsed" id="collapse_bro" href="#" data-bs-toggle="collapse" data-bs-target="#collapseBro" aria-expanded="false" aria-controls="collapsePages">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-window-restore"></i></div>
                    브로슈어
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="collapseBro" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                        <a class="nav-link collapsed <?=$url=="backnote_list"?'text-light':''?>" href="bro_notice.php" >공지사항</a>
                        <a class="nav-link collapsed <?=$url=="backmanual_list"?'text-light':''?>" href="bro_manual.php" >사용자 매뉴얼</a>
                        <a class="nav-link collapsed <?=$url=="backfaq_list"?'text-light':''?>" href="bro_faq.php" >FAQs</a>
                        <a class="nav-link collapsed <?=$url=="backsample_list"?'text-light':''?>" href="bro_sample.php" >활용사례</a>
                    </nav>
                </div>
                ...
                <a class="nav-link" href="/challenge/challenge_template.php"><div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>챌린지 템플릿 페이지 </a>
            </div>
        </div>
