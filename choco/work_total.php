<?
    ...
    //오늘 업무 수치
    $sql = "select count(idx) as cnt from work_todaywork where state = '0' and work_flag = '2' and share_flag = '0' ";
    ...
    //오늘 보고 수치
    $sql = "select count(idx) as cnt from work_todaywork where state = '0' and work_flag = '1' and work_idx is null ";
    $query = selectQuery($sql);
    $nocal_report = $query['cnt'];
    $sql = $sql .= "and (workdate >= '".$last_week."' and workdate <= '".$today."')";
    $query = selectQuery($sql);
    $report = $query['cnt'];

    //오늘 요청 수치
    $sql = "select count(idx) as cnt from work_todaywork where state = '0' and work_flag = '3' and work_idx is null ";
    $query = selectQuery($sql);
    $nocal_request = $query['cnt'];
    $sql = $sql .= "and (workdate >= '".$last_week."' and workdate <= '".$today."')";
    $query = selectQuery($sql);
    $request = $query['cnt'];
    
    //오늘 공유 수치
    $sql = "select count(idx) as cnt from work_todaywork where state = '0' and work_flag = '2' and share_flag = '1' ";
    $query = selectQuery($sql);
    $nocal_share = $query['cnt'];
    $sql = $sql .= "and (workdate >= '".$last_week."' and workdate <= '".$today."')";
    $query = selectQuery($sql);
    $share = $query['cnt'];
