<?
	...
	$sql = "select idx, state, service, contents, title from bro_manual where idx = '".$idx."' ";
            ...
            <?php include "admin_sidebar.php"; ?>
            	<div id="layoutSidenav_content">
                    <div class="container-fluid px-4" id="page-screen">
						<h1 class="mt-4">브로슈어 매뉴얼</h1>
                        <div class="card mb-4">
                            <input type="hidden" id="backwrite_type" value="bro_manual_write">
                            <? if($idx){?>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="mb-3 col-md-6 ">
                                            <!-- <label for="notice_title" class="form-label">매뉴얼 제목</label> -->
                                            <input type="text" class="form-control" id="notice_title" placeholder="매뉴얼 타이틀을 입력해주세요." value="<?=$ch_title?>">
                                        </div>
                                        <div class="mb-3 col-md-2 ms-2">
                                            <select class="form-select border" aria-label="Default select example" id="manual_kind">
                                                <option selected>매뉴얼 유형</option>
                                                <option value="start">처음</option>
                                                <option value="team">메인화면</option>
                                                <option value="todaywork">오늘업무</option>
                                                <option value="live">라이브</option>
                                                <option value="reward">보상/코인</option>
                                                <option value="admin">관리자</option>
                                                <option value="challenge">챌린지</option>
                                                <option value="party">파티</option>
                                                <option value="insight">인사이트</option>
                                                <option value="item">아이템샵</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
