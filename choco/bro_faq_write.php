<?
	...
	$sql = "select idx, state, contents, title from bro_faq where idx = '".$idx."' ";
            ...
            <?php include "admin_sidebar.php"; ?>
            	<div id="layoutSidenav_content">
                    <div class="container-fluid px-4" id="page-screen">
                        ...
                        <div class="card mb-4">
							<input type="hidden" id="backwrite_type" value="bro_faq_write">
                            <? if($idx){?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-3 col-6 ">
                                        <label for="notice_title" class="form-label">자주묻는 질문</label>
                                        <input type="text" class="form-control" id="notice_title" placeholder="FAQ 타이틀을 입력해주세요." value="<?=$ch_title?>">
                                    </div>
                                </div>
