<?
	...
	$sql = "select count(idx) as cnt from bro_sample where state in ('0','1') order by idx desc limit 0,10";
            ...
            <?php include "admin_sidebar.php"; ?>
            	<div id="layoutSidenav_content">
                    <div class="container-fluid px-4" id="page-screen">
						...
						<input type="hidden" id="backoffice_type" value="backsample_list">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <table class="table table-bordered rounded-1 mt-3" id="backoff_table" class="rounded-1">
                                    ...
                                    <tbody>
                                        <?
											$sql = "select idx, email, title, regdate, state, (select name from work_member where email = bro_sample.email and state = '0') as name from bro_sample where state in ('0','1') order by idx desc";	
