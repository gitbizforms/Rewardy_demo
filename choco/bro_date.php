                        ...
                        <div class="card mb-4">
                            <div class="card-body">
								...
								<?// Check if the request was successful
									...
									$holidays = json_decode($response, true);
									// Check if holidays are available
									if (count($holidays) > 0) {
										echo "Korea's Public Holidays in 2024:<br>";
										$i = 0;
										foreach ($holidays as $holiday) {
											...
											if(TODATE == $holiday['date']){
												...
												$dateTime = new DateTime($holiday['date']);
												$dateTime->modify("+1 day");
												$result = $dateTime->format('Y-m-d');
												echo $result . " - " . $holiday['name'] . "<br>";
												continue;
											}
										}
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Bizform & Rewardy & <?=$yoil_check?></div>
                            <div>
