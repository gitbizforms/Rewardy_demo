...
$(document).on("click",".tuto_pop_03_02 .tuto_next",function(){
    ...
    $.ajax({
        ...
        success: function (data) {
			...
			$(".tuto_mark_03_02").hide();
			$(".tuto_pop_03_02").hide();
			$(".phase_03").removeClass("tuto_on");
			$(".phase_03").addClass("tuto_clear");
			if(tuto_flag==2){
				$(".phase_04").addClass("tuto_on");
			}
			// $(".phase_04").addClass("tuto_on");
			$(".phase_04 button").attr("onclick","location.href='/party/tu_project.php'");
			$(".tuto_phase").show();
        },
      });
    });
														...
														<div class="tdw_list_box">
															...
															<div class="tdw_list_function new_type">
																<div class="tdw_list_function_in">
																	<button class="tdw_list_100 tuto tuto_03_01" title="코인" id=""><span>100</span></button>
																	<button class="tdw_list_h" title="좋아요" id=""><span>좋아요</span></button>
