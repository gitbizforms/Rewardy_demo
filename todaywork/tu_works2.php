															...
															<li class="tdw_list_li<?=$li_class?>" id="workslist_<?=$idx?>" value="<?=($i+1)?>">
																<div class="tdw_list_box<?=($state=='1')?" on":""?><?=$share_view_bt_style?>" id="tdw_list_box_<?=$idx?>">
																	<div class="tdw_list_chk">
																		...
																		<?if($work_flag=='1'){?>
																			<button class="btn_tdw_list_chk tuto tuto_01_03" <?=$tdw_list?" id='tdw_dlist_chk'":""?>><span>완료체크</span></button>
											
																		<?}else{?>
																			<button class="btn_tdw_list_chk tuto tuto_01_03" value="<?=$idx?>" <?=$tdw_list?" id='tdw_dlist_chk'":""?>><span>완료체크</span></button>
																		<?}?>
																	...
																	<div class="tdw_list_function">
																		<div class="tdw_list_function_in">
																			...
																			<?if($notice_flag=='0' || $decide_flag=='0'){?>
																				<button class="tdw_list_party_link<?=$project_link_info[$idx]?" on":""?> tuto tuto_01_04" id="tdw_list_party_link" value="<?=$idx?>" title="파티연결"><span>파티연결</span></button>
																			<?}?>
