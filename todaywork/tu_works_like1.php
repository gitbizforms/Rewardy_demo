<?
	...
	if($user_id=='sadary0@nate.com'){
		//print "<pre>";
		//print_r($work_share_user);
		//echo $work_share_user['receive']['64474'];
		//print "</pre>";
	}
																			...
																			<?}else{?>
																				...
																				<?//공유받음 : share_flag=2
																					...
																					if($user_id=='sadary0@nate.com'){
																						...
																						//echo $work_title. " #######" . $work_share_user['receive']['64474'];
																						echo "########## ". $work_idx;
																					}
																	...
																	<div class="tdw_list_function">
																		<div class="tdw_list_function_in">
																			...
																			//공유받음
																				...
																				<button class="tdw_list_shared_hart<?=$work_like_list[$work_idx]>0?" on":""?> tuto tuto_02_01" title="좋아요" <?=$work_like_list[$work_idx]>0?"":" id=\"tdw_list_jjim_2\""?> value="<?=$work_idx?>"><span>좋아요</span></button>
																			<?}else{?>
...
<div class="tuto_phase" style="display:none;">
	...
	<div class="tuto_phase_in">
		...
		<div class="tuto_phase_list tuto_clear">
			...
			<div class="tuto_phase_box phase_03 tuto_on">
				<p>3</p>
				<button onclick="location.href='/todaywork/tu_works_coin.php'">
					<dl>
						<dt>코인 보상</dt>
						<dd>
							<span>좋아요</span>
