    ...
    (function() {
        ...
        datepicker.prototype = {
            ...
            _setInputValue: function() {
                ...
                if (value != "") {
                    //console.log("  ::::: " + value);
                    if (this.$el.attr("id") == "sdate") {
                        $("#sdate").val(value);
                        challenges_reward_coin();
                        $("#ch_daily").trigger("click");
                        $("#ch_daily").trigger("click");
                    }

                    if (this.$el.attr("id") == "edate") {
                        $("#edate").val(value);
                        challenges_reward_coin();
                        $("#ch_daily").trigger("click");
                        $("#ch_daily").trigger("click");
                ...
                //리스트 상단 달력포멧형식(yyyy-mm-dd ==> yyyy.mm.dd)
                if (this.$el.attr("id") == "work_date") {
                    var value_old = value;
                    value = value.replace(/-/g, '.');
                    this.$el.val(value);

                    $("#work_wdate").val(value);
                    date_change();
                    works_list();

                } else if (this.$el.attr("id") == "work_month") {

                    var value_old = value;
                    value = value.replace(/-/g, '.');
                    this.$el.val(value);

                    $("#work_month").val(value);
                    date_change();
                    works_list();


                } else if (this.$el.attr("id") == "r_work_date") {
                    var value_old = value;
                    value = value.replace(/-/g, '.');
                    this.$el.val(value);

                    $("#r_work_wdate").val(value);
                    r_date_change();
                    rank_list();

                } else if (this.$el.attr("id") == "r_work_month") {
                ...
                } else if (this.$el.attr("id") == "lives_date") {
                    ...
                    /*} else if (this.$el.attr("id") == "input_cha_date_l" || this.$el.attr("id") == "input_cha_date_r") {
				...
				*/
                    ...
                    if ($("#sdate").val() && $("#edate").val()) {
                        ...
                        edate = $("#edate").val();
                        console.log(sdate);
                        var date_diff = dateDiff($("#sdate").val(), $("#edate").val());
                        if(date_diff < 0){
                            date_diff = 1;
                            $(".input_cha_date_r").val(sdate);
                        }
                        if (date_diff) {
                    ...
                    if (this.$el.attr("id").indexOf("listdate_") == 0) {
                        var date_val = this.$el.attr("id").replace("listdate_", "");
                        var date_id = this.$el.attr("id");
                        works_datechange(date_id, value);
                    }
    ...
    (function() {
        ...
        datepicker.Body.prototype = {
            ...
            _getDayNamesHtml: function(firstDay, curDay, html, i) {
                ...
                html += '<div class="datepicker--day-name' + week0 + '">' + this.d.loc.daysMin[curDay] + '</div>';
            ...
            _getCellContents: function(date, type) {
                ...
                switch (type) {
                    case 'day':
                        ...
                        if (d.month != this.d.parsedDate.month && d.day == 0) {
                            classes += " --weekend2 -other-months";
                        } else if (d.month != this.d.parsedDate.month && d.day == 6) {
                            classes += " --weekend -other-months";
                        } else if (d.day == 0) {
                            classes += "--weekend2";
                        } else if (d.day == 6) {
                            classes += "--weekend";
