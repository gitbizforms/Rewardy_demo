										...
										<div class="tdw_ins_tab_in">
											<ul>
												...
												<li>
													...
													<button disabled='disabled' class="select_c_mm"><span>월간</span></button>
												</li>
											</ul>
										</div>
									</div>
							...
							<div class="rew_ins">
						        ...
						        <ul>
						          <?
						            ...
						            $sql = $sql .= " where code not in (510,520,620,600,710,810,830,630,640,1120,1110) and DATE_FORMAT(workdate, '%Y-%m') = '".$ym."' and state = 0";
						            $sql = $sql .= " and companyno = '".$companyno."'";
	
						            $rank = selectQuery($sql);
						          ...
						          ?>
						            <li class="ir_rank_<?=$i+1?>">
						              <div class="ins_rank_user">
						                ...
						                <div class="ir_name">
						                  <div class="ir_name_user"><?=$rank['sum']?></div>
