...
<link href="http://www.bizforms.co.kr/css/bootstrap3/bootstrap.min.css" rel="stylesheet" />
<link href="http://www.bizforms.co.kr/css/bootstrap3/bootstrap-theme.min.css" rel="stylesheet" />

<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.5/css/bootstrap.css" rel="stylesheet">

<link href="http://invitation.bizforms.co.kr/css/common.css" rel="stylesheet">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.2/lang/summernote-ko-KR.js"></script>
...
<script src="http://invitation.bizforms.co.kr/js/invitation.js"></script>
...
<script>
	...
	$('#contents').summernote({
		...
		toolbar: [
			...
			['size', ['fontsize']],
			['font', ['fontname']],
			['custom', ['editingclose', 'uservideo']],
			// ['custom', [ 'editingclose']],
			['save', ['saveBtn']],
			['usercontrol', ['ctlvideo', 'ctlphoto', 'ctlmap']]
		],
		fontNames: ['돋움', '돋움체', '굴림', '굴림체', '바탕', '궁서', '나눔고딕', 'Arial', 'Arial Black', 'Comic Sans MS', 'Courier New'],
		fontNamesIgnoreCheck: ['돋움', '돋움체', '굴림', '굴림체', '바탕', '궁서', '나눔고딕'],
		lang: "ko-KR",
	//	buttons: { editingclose: editingCloseButton, uservideo: addVideo, saveBtn: saveButton, ctlvideo: use_video, ctlphoto: use_photo, ctlmap: use_map },
		fontSizes: ['14', '18', '24', '32', '38', '44', '52', '56', '58', '60', '64', '70'],
									...
									<div class="tc_index_my">
										...
										<div class="tc_index_box" id="tab_work">
											<div class="tc_box_add">
												<div class="tc_input">
													<textarea name="summernote" id="summernote" class="input_01"></textarea>
