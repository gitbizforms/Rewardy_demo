...
if($user_id=='sadary0@nate.com' || $user_id=='qohse@nate.com' || $user_id=='adsb123@naver.com' || $user_id=='fpa5023@naver.com'|| $user_id=='adsb12@nate.com'){

	//echo "dir_name".get_dirname();
	...
	//echo "############";
	//echo $penalty_info_cnt[$member_list_email];
	//$penalty_logoff_cnt = 2;

	//$penalty_attend_cnt = 2;

}


//페널티(지각) 정보내역
$sql = "select idx, work_idx, file_real_name from work_filesinfo_file where idx='337'";
$penalty_file_info = selectQuery($sql);
if($penalty_file_info['idx']){
	$penalty_file_info_01['work_idx'] = $penalty_file_info['work_idx'];
	$penalty_file_info_01['file_real_name'] = $penalty_file_info['file_real_name'];
}

//페널티(오늘업무) 정보내역
$sql = "select idx, work_idx, file_real_name from work_filesinfo_file where idx='339'";
$penalty_file_info = selectQuery($sql);
if($penalty_file_info['idx']){
	$penalty_file_info_02['work_idx'] = $penalty_file_info['work_idx'];
	$penalty_file_info_02['file_real_name'] = $penalty_file_info['file_real_name'];
}

//페널티(퇴근) 정보내역
$sql = "select idx, work_idx, file_real_name from work_filesinfo_file where idx='340'";
$penalty_file_info = selectQuery($sql);
if($penalty_file_info['idx']){
	$penalty_file_info_03['work_idx'] = $penalty_file_info['work_idx'];
	$penalty_file_info_03['file_real_name'] = $penalty_file_info['file_real_name'];
}

if ($penalty_attend_cnt > 1){

	//오늘업무에서 레이어 제외 처리
	if ($get_dirname != 'todaywork' && $get_dirname != 'live'){	?>
		<!-- 페널티 -->
...
?>
	<div class="penalty_layer" style="display: none;" id="penalty_layer_01">
		<input type="hidden" id="penalty_uid_01">
		...
		<div class="pl_in">
			<div class="pl_box">
				<div class="pl_box_in">
					...
					<div class="pl_area">
						<div class="pl_user">
							<div class="user_img" style="background-image:url(<?=$member_row_info['profile_img_src']?>);" id="member_row_info_01"></div>
							<div class="user_name" id="pl_name_01">
						...
						<div class="pl_left">
							...
							<div class="pl_file">
								<div class="file_box" id="file_box_01" value="<?=$penalty_file_info_01['work_idx']?>">
									<div class="file_desc">
										<span><?=$penalty_file_info_01['file_real_name']?></span>
										<strong>다운로드</strong>
									</div>
								</div>
							</div>
							...
							<div class="pl_right_02">
								...
								<div class="pl_upload">
									<div class="file_box" id="pl_img_btn">
										<button class="input_file" id="bt_file_01" value=""></button>
										<input type="file" class="input_file" id="pl_file_01">
	...
	if($penalty_work_cnt > 1){
		...
		<input type="hidden" id="penalty_uid_02">
			<div class="pl_deam"></div>
			<div class="pl_in">
				<div class="pl_box">
					<div class="pl_box_in">
						...
						<div class="pl_area">
							<div class="pl_user">
								<div class="user_img" style="background-image:url(<?=$member_row_info['profile_img_src']?>);" id="profile_img_src_02"></div>
								<div class="user_name" id="pl_name_02">
									<strong><?=$member_row_info['name']?></strong>
									<?=$member_row_info['part']?>
								</div>
							</div>
							...
							<p>📌 오늘업무에 <strong>[연차]</strong> 등록 시 해당일은 페널티가 적용되지 않습니다.</p>
								<div class="pl_file">
									<div class="file_box" id="file_box_02" value="<?=$penalty_file_info_02['work_idx']?>">
										<div class="file_desc">
											<span><?=$penalty_file_info_02['file_real_name']?></span>
											<strong>다운로드</strong>
										</div>
									</div>
								</div>
								...
								<div class="pl_right_02">
									...
									<div class="pl_upload">
										<div class="file_box">
											...
											<button class="input_file" id="bt_file_02" value=""></button>
											<input type="file" class="input_file" id="pl_file_02">
											<label for="bt_file_02" class="label_file"><span>이미지 올리기</span></label>
	...
	if($penalty_logoff_cnt > 1){
		...
		if (date("H") >= ATTEND_STIME){
			...
			<input type="hidden" id="penalty_uid_03">
				<div class="pl_deam"></div>
				<div class="pl_in">
					<div class="pl_box">
						<div class="pl_box_in">
							...
							<div class="pl_area">
								<div class="pl_user">
									<div class="user_img" style="background-image:url(<?=$member_row_info['profile_img_src']?>);" id="member_row_info_03"></div>
									<div class="user_name" id="pl_name_03">
									<strong><?=$member_row_info['name']?></strong>
										<?=$member_row_info['part']?>
									</div>
								</div>
								<div class="pl_left">
									...
									<p>📌 오늘업무에 <strong>[연차]</strong> 등록 시 해당일은 페널티가 적용되지 않습니다.</p>
									<div class="pl_file">
										<div class="file_box" id="file_box_03" value="<?=$penalty_file_info_03['work_idx']?>">
											<div class="file_desc">
												<span><?=$penalty_file_info_03['file_real_name']?></span>
												<strong>다운로드</strong>
											</div>
										</div>
									</div>
									...
									<div class="pl_right_02">
										...
										<div class="pl_upload">
											<div class="file_box">
												...
												<button class="input_file" id="bt_file_03" value=""></button>
												<input type="file" class="input_file" id="pl_file_03">
												<label for="bt_file_03" class="label_file"><span>이미지 올리기</span></label>
